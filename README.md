...
## 本项目获取地址：https://www.bishecode.com/product/188/
...
图5.3 资讯类型管理页面【如图5.3显示的就是资讯类型管理页面，此页面提供给管理员的功能有：根据资讯类型进行条件查询，还可以对资讯类型行新增、修改、查询操作等等。】
![alt text](images/image-5.png)

图5.4 商品资讯管理页面【如图5.4显示的就是商品资讯管理页面，此页面提供给管理员的功能有：根据商品资讯进行新增、修改、查询操作等等。】
